...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
       b:	c7 44 24 04 92 41 00 	movl   $0x4192,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 9c 3d 00 00       	call   3db7 <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
      3d:	c7 44 24 04 9d 41 00 	movl   $0x419d,0x4(%esp)
      44:	00 
      45:	89 04 24             	mov    %eax,(%esp)
      48:	e8 6a 3d 00 00       	call   3db7 <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
      b6:	c7 44 24 04 e9 41 00 	movl   $0x41e9,0x4(%esp)
      bd:	00 
      be:	89 04 24             	mov    %eax,(%esp)
      c1:	e8 f1 3c 00 00       	call   3db7 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
      e8:	c7 44 24 04 00 42 00 	movl   $0x4200,0x4(%esp)
      ef:	00 
      f0:	89 04 24             	mov    %eax,(%esp)
      f3:	e8 bf 3c 00 00       	call   3db7 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     109:	c7 44 24 04 1b 42 00 	movl   $0x421b,0x4(%esp)
     110:	00 
     111:	89 04 24             	mov    %eax,(%esp)
     114:	e8 9e 3c 00 00       	call   3db7 <printf>
    exit();
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     1b3:	c7 44 24 04 98 42 00 	movl   $0x4298,0x4(%esp)
     1ba:	00 
     1bb:	89 04 24             	mov    %eax,(%esp)
     1be:	e8 f4 3b 00 00       	call   3db7 <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     1f0:	c7 44 24 04 a3 42 00 	movl   $0x42a3,0x4(%esp)
     1f7:	00 
     1f8:	89 04 24             	mov    %eax,(%esp)
     1fb:	e8 b7 3b 00 00       	call   3db7 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     22e:	c7 44 24 04 bc 42 00 	movl   $0x42bc,0x4(%esp)
     235:	00 
     236:	89 04 24             	mov    %eax,(%esp)
     239:	e8 79 3b 00 00       	call   3db7 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     248:	c7 44 24 04 d7 42 00 	movl   $0x42d7,0x4(%esp)
     24f:	00 
     250:	89 04 24             	mov    %eax,(%esp)
     253:	e8 5f 3b 00 00       	call   3db7 <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     27a:	c7 44 24 04 ea 42 00 	movl   $0x42ea,0x4(%esp)
     281:	00 
     282:	89 04 24             	mov    %eax,(%esp)
     285:	e8 2d 3b 00 00       	call   3db7 <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     2cb:	c7 44 24 04 20 43 00 	movl   $0x4320,0x4(%esp)
     2d2:	00 
     2d3:	89 04 24             	mov    %eax,(%esp)
     2d6:	e8 dc 3a 00 00       	call   3db7 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     2fd:	c7 44 24 04 34 43 00 	movl   $0x4334,0x4(%esp)
     304:	00 
     305:	89 04 24             	mov    %eax,(%esp)
     308:	e8 aa 3a 00 00       	call   3db7 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     ...
     35e:	e8 54 3a 00 00       	call   3db7 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     3a3:	c7 44 24 04 6c 43 00 	movl   $0x436c,0x4(%esp)
     3aa:	00 
     3ab:	89 04 24             	mov    %eax,(%esp)
     3ae:	e8 04 3a 00 00       	call   3db7 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3f0:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     3f5:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 85 43 00 	movl   $0x4385,0x4(%esp)
     403:	00 
     404:	89 04 24             	mov    %eax,(%esp)
     407:	e8 ab 39 00 00       	call   3db7 <printf>
        exit();
     ...
     41a:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     41f:	8b 55 f4             	mov    -0xc(%ebp),%edx
     422:	89 54 24 08          	mov    %edx,0x8(%esp)
     426:	c7 44 24 04 a2 43 00 	movl   $0x43a2,0x4(%esp)
     42d:	00 
     42e:	89 04 24             	mov    %eax,(%esp)
     431:	e8 81 39 00 00       	call   3db7 <printf>
      exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     4d4:	c7 44 24 04 f8 43 00 	movl   $0x43f8,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 d3 38 00 00       	call   3db7 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     56f:	c7 44 24 04 20 44 00 	movl   $0x4420,0x4(%esp)
     576:	00 
     577:	89 04 24             	mov    %eax,(%esp)
     57a:	e8 38 38 00 00       	call   3db7 <printf>
}
     57f:	c9                   	leave  
     580:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     58c:	c7 44 24 04 46 44 00 	movl   $0x4446,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 1b 38 00 00       	call   3db7 <printf>
  ...
  if(mkdir("dir0") < 0){
    ...
    printf(stdout, "mkdir failed\n");
     5ac:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     5b1:	c7 44 24 04 57 44 00 	movl   $0x4457,0x4(%esp)
     5b8:	00 
     5b9:	89 04 24             	mov    %eax,(%esp)
     5bc:	e8 f6 37 00 00       	call   3db7 <printf>
    exit();
  ...
  if(chdir("dir0") < 0){
    ...
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     5db:	c7 44 24 04 65 44 00 	movl   $0x4465,0x4(%esp)
     5e2:	00 
     5e3:	89 04 24             	mov    %eax,(%esp)
     5e6:	e8 cc 37 00 00       	call   3db7 <printf>
    exit();
  ...
  if(chdir("..") < 0){
    ...
    printf(stdout, "chdir .. failed\n");
     600:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     605:	c7 44 24 04 7b 44 00 	movl   $0x447b,0x4(%esp)
     60c:	00 
     60d:	89 04 24             	mov    %eax,(%esp)
     610:	e8 a2 37 00 00       	call   3db7 <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     666:	c7 44 24 04 a0 44 00 	movl   $0x44a0,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 41 37 00 00       	call   3db7 <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 c0 5e 00 	movl   $0x5ec0,0x4(%esp)
     67d:	00 
    ...
    printf(stdout, "exec echo failed\n");
     68e:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
     693:	c7 44 24 04 ab 44 00 	movl   $0x44ab,0x4(%esp)
     69a:	00 
     69b:	89 04 24             	mov    %eax,(%esp)
     69e:	e8 14 37 00 00       	call   3db7 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     ...
     6ce:	e8 e4 36 00 00       	call   3db7 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     75e:	e8 54 36 00 00       	call   3db7 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7d7:	e8 db 35 00 00       	call   3db7 <printf>
          return;
    ...
    if(total != 5 * 1033){
     ...
     84d:	e8 65 35 00 00       	call   3db7 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     ...
     876:	e8 3c 35 00 00       	call   3db7 <printf>
    ...
    printf(1, "fork() failed\n");
     ...
     88c:	e8 26 35 00 00       	call   3db7 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     8ad:	e8 05 35 00 00       	call   3db7 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     925:	e8 8d 34 00 00       	call   3db7 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     971:	e8 41 34 00 00       	call   3db7 <printf>
    return;
  ...
  printf(1, "kill... ");
     ...
     992:	e8 20 34 00 00       	call   3db7 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     9c7:	e8 eb 33 00 00       	call   3db7 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     9ea:	e8 c8 33 00 00       	call   3db7 <printf>
}
     9ef:	c9                   	leave  
     9f0:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a1d:	e8 95 33 00 00       	call   3db7 <printf>
      return;
    ...
    if(pid){
     ...
     a43:	e8 6f 33 00 00       	call   3db7 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     ...
     a68:	e8 4a 33 00 00       	call   3db7 <printf>
}
     a6d:	c9                   	leave  
     a6e:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     a84:	e8 2e 33 00 00       	call   3db7 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     b14:	e8 9e 32 00 00       	call   3db7 <printf>
      kill(ppid);
    ...
    printf(1, "mem ok\n");
     ...
     b43:	e8 6f 32 00 00       	call   3db7 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     b69:	e8 49 32 00 00       	call   3db7 <printf>
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     ba6:	e8 0c 32 00 00       	call   3db7 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c18:	e8 9a 31 00 00       	call   3db7 <printf>
      break;
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     c73:	e8 3f 31 00 00       	call   3db7 <printf>
    return;
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     d1e:	e8 94 30 00 00       	call   3db7 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d42:	e8 70 30 00 00       	call   3db7 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     ...
     d63:	e8 4f 30 00 00       	call   3db7 <printf>
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     ...
     d9d:	e8 15 30 00 00       	call   3db7 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     ...
     de7:	e8 cb 2f 00 00       	call   3db7 <printf>
    exit();
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e61:	e8 51 2f 00 00       	call   3db7 <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f06:	e8 ac 2e 00 00       	call   3db7 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
     ...
     f70:	e8 42 2e 00 00       	call   3db7 <printf>
      exit();
  ...
  printf(1, "twofiles ok\n");
     ...
     faf:	e8 03 2e 00 00       	call   3db7 <printf>
}
     fb4:	c9                   	leave  
     fb5:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     ...
     fcb:	e8 e7 2d 00 00       	call   3db7 <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     ...
     fed:	e8 c5 2d 00 00       	call   3db7 <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1050:	e8 62 2d 00 00       	call   3db7 <printf>
      exit();
    ...
    1096:	c7 44 24 04 e3 46 00 	movl   $0x46e3,0x4(%esp)
    109d:	00 
    109e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a5:	e8 0d 2d 00 00       	call   3db7 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1115:	c7 44 24 04 f4 46 00 	movl   $0x46f4,0x4(%esp)
    111c:	00 
    111d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1124:	e8 8e 2c 00 00       	call   3db7 <printf>
      exit();
    ...
    1147:	c7 44 24 04 18 47 00 	movl   $0x4718,0x4(%esp)
    114e:	00 
    114f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1156:	e8 5c 2c 00 00       	call   3db7 <printf>
      exit();
    ...
    11ad:	c7 44 24 04 f4 46 00 	movl   $0x46f4,0x4(%esp)
    11b4:	00 
    11b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11bc:	e8 f6 2b 00 00       	call   3db7 <printf>
      exit();
    ...
    11df:	c7 44 24 04 18 47 00 	movl   $0x4718,0x4(%esp)
    11e6:	00 
    11e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11ee:	e8 c4 2b 00 00       	call   3db7 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1251:	c7 44 24 04 38 47 00 	movl   $0x4738,0x4(%esp)
    1258:	00 
    1259:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1260:	e8 52 2b 00 00       	call   3db7 <printf>
}
    1265:	c9                   	leave  
    1266:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    126d:	c7 44 24 04 49 47 00 	movl   $0x4749,0x4(%esp)
    1274:	00 
    1275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127c:	e8 36 2b 00 00       	call   3db7 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1281:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1288:	00 
    1289:	c7 04 24 5a 47 00 00 	movl   $0x475a,(%esp)
  ...
  if(fd < 0){
    ...
    129e:	c7 44 24 04 65 47 00 	movl   $0x4765,0x4(%esp)
    12a5:	00 
    12a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12ad:	e8 05 2b 00 00       	call   3db7 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12be:	00 
    12bf:	c7 44 24 04 7f 47 00 	movl   $0x477f,0x4(%esp)
    12c6:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e4:	00 
    12e5:	c7 04 24 5a 47 00 00 	movl   $0x475a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1399:	c7 44 24 04 bb 47 00 	movl   $0x47bb,0x4(%esp)
    13a0:	00 
    13a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13a8:	e8 0a 2a 00 00       	call   3db7 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    13bd:	c7 44 24 04 d2 47 00 	movl   $0x47d2,0x4(%esp)
    13c4:	00 
    13c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13cc:	e8 e6 29 00 00       	call   3db7 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13f6:	c7 44 24 04 e9 47 00 	movl   $0x47e9,0x4(%esp)
    13fd:	00 
    13fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1405:	e8 ad 29 00 00       	call   3db7 <printf>
    exit();
  ...
  unlink("unlinkread");
    141a:	c7 04 24 5a 47 00 00 	movl   $0x475a,(%esp)
    1421:	e8 52 28 00 00       	call   3c78 <unlink>
  printf(1, "unlinkread ok\n");
    1426:	c7 44 24 04 02 48 00 	movl   $0x4802,0x4(%esp)
    142d:	00 
    142e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1435:	e8 7d 29 00 00       	call   3db7 <printf>
}
    143a:	c9                   	leave  
    143b:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1442:	c7 44 24 04 11 48 00 	movl   $0x4811,0x4(%esp)
    1449:	00 
    144a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1451:	e8 61 29 00 00       	call   3db7 <printf>

  unlink("lf1");
    1456:	c7 04 24 1b 48 00 00 	movl   $0x481b,(%esp)
    145d:	e8 16 28 00 00       	call   3c78 <unlink>
  unlink("lf2");
    1462:	c7 04 24 1f 48 00 00 	movl   $0x481f,(%esp)
    1469:	e8 0a 28 00 00       	call   3c78 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    146e:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1475:	00 
    1476:	c7 04 24 1b 48 00 00 	movl   $0x481b,(%esp)
  ...
  if(fd < 0){
    ...
    148b:	c7 44 24 04 23 48 00 	movl   $0x4823,0x4(%esp)
    1492:	00 
    1493:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149a:	e8 18 29 00 00       	call   3db7 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14ab:	00 
    14ac:	c7 44 24 04 7f 47 00 	movl   $0x477f,0x4(%esp)
    14b3:	00 
    ...
    14c4:	c7 44 24 04 36 48 00 	movl   $0x4836,0x4(%esp)
    14cb:	00 
    14cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d3:	e8 df 28 00 00       	call   3db7 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    155d:	00 
    155e:	c7 04 24 1f 48 00 00 	movl   $0x481f,(%esp)
  ...
  if(fd < 0){
    ...
    1573:	c7 44 24 04 85 48 00 	movl   $0x4885,0x4(%esp)
    157a:	00 
    157b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1582:	e8 30 28 00 00       	call   3db7 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15ac:	c7 44 24 04 96 48 00 	movl   $0x4896,0x4(%esp)
    15b3:	00 
    15b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15bb:	e8 f7 27 00 00       	call   3db7 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15d0:	c7 44 24 04 1f 48 00 	movl   $0x481f,0x4(%esp)
    15d7:	00 
    15d8:	c7 04 24 1f 48 00 00 	movl   $0x481f,(%esp)
    15df:	e8 a4 26 00 00       	call   3c88 <link>
    15e4:	85 c0                	test   %eax,%eax
    15e6:	78 19                	js     1601 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e8:	c7 44 24 04 a7 48 00 	movl   $0x48a7,0x4(%esp)
    15ef:	00 
    15f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15f7:	e8 bb 27 00 00       	call   3db7 <printf>
    exit();
    15fc:	e8 27 26 00 00       	call   3c28 <exit>
  }

  unlink("lf2");
    1601:	c7 04 24 1f 48 00 00 	movl   $0x481f,(%esp)
    1608:	e8 6b 26 00 00       	call   3c78 <unlink>
  if(link("lf2", "lf1") >= 0){
    160d:	c7 44 24 04 1b 48 00 	movl   $0x481b,0x4(%esp)
    1614:	00 
    1615:	c7 04 24 1f 48 00 00 	movl   $0x481f,(%esp)
    161c:	e8 67 26 00 00       	call   3c88 <link>
    1621:	85 c0                	test   %eax,%eax
    1623:	78 19                	js     163e <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1625:	c7 44 24 04 c8 48 00 	movl   $0x48c8,0x4(%esp)
    162c:	00 
    162d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1634:	e8 7e 27 00 00       	call   3db7 <printf>
    exit();
    1639:	e8 ea 25 00 00       	call   3c28 <exit>
  }

  if(link(".", "lf1") >= 0){
    163e:	c7 44 24 04 1b 48 00 	movl   $0x481b,0x4(%esp)
    1645:	00 
    1646:	c7 04 24 eb 48 00 00 	movl   $0x48eb,(%esp)
    164d:	e8 36 26 00 00       	call   3c88 <link>
    1652:	85 c0                	test   %eax,%eax
    1654:	78 19                	js     166f <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1656:	c7 44 24 04 ed 48 00 	movl   $0x48ed,0x4(%esp)
    165d:	00 
    165e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1665:	e8 4d 27 00 00       	call   3db7 <printf>
    exit();
    166a:	e8 b9 25 00 00       	call   3c28 <exit>
  }

  printf(1, "linktest ok\n");
    166f:	c7 44 24 04 09 49 00 	movl   $0x4909,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 34 27 00 00       	call   3db7 <printf>
}
    1683:	c9                   	leave  
    1684:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168b:	c7 44 24 04 16 49 00 	movl   $0x4916,0x4(%esp)
    1692:	00 
    1693:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169a:	e8 18 27 00 00       	call   3db7 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16fe:	c7 04 24 26 49 00 00 	movl   $0x4926,(%esp)
    ...
    1741:	c7 04 24 26 49 00 00 	movl   $0x4926,(%esp)
    ...
    1772:	c7 44 24 04 29 49 00 	movl   $0x4929,0x4(%esp)
    1779:	00 
    177a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1781:	e8 31 26 00 00       	call   3db7 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 eb 48 00 00 	movl   $0x48eb,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1838:	c7 44 24 04 45 49 00 	movl   $0x4945,0x4(%esp)
    183f:	00 
    1840:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1847:	e8 6b 25 00 00       	call   3db7 <printf>
        exit();
    ...
    1868:	c7 44 24 04 5e 49 00 	movl   $0x495e,0x4(%esp)
    186f:	00 
    1870:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1877:	e8 3b 25 00 00       	call   3db7 <printf>
        exit();
  ...
  if(n != 40){
    ...
    18c4:	c7 44 24 04 7c 49 00 	movl   $0x497c,0x4(%esp)
    18cb:	00 
    18cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18d3:	e8 df 24 00 00       	call   3db7 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    18fe:	79 19                	jns    1919 <concreate+0x294>
      printf(1, "fork failed\n");
    1900:	c7 44 24 04 69 45 00 	movl   $0x4569,0x4(%esp)
    1907:	00 
    1908:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190f:	e8 a3 24 00 00       	call   3db7 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a20:	c7 44 24 04 ad 49 00 	movl   $0x49ad,0x4(%esp)
    1a27:	00 
    1a28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a2f:	e8 83 23 00 00       	call   3db7 <printf>
}
    1a34:	c9                   	leave  
    1a35:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a3c:	c7 44 24 04 bb 49 00 	movl   $0x49bb,0x4(%esp)
    1a43:	00 
    1a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a4b:	e8 67 23 00 00       	call   3db7 <printf>

  unlink("x");
    1a50:	c7 04 24 22 45 00 00 	movl   $0x4522,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a6a:	c7 44 24 04 69 45 00 	movl   $0x4569,0x4(%esp)
    1a71:	00 
    1a72:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a79:	e8 39 23 00 00       	call   3db7 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad8:	00 
    1ad9:	c7 04 24 22 45 00 00 	movl   $0x4522,(%esp)
    ...
    1b0a:	75 16                	jne    1b22 <linkunlink+0xec>
      link("cat", "x");
    1b0c:	c7 44 24 04 22 45 00 	movl   $0x4522,0x4(%esp)
    1b13:	00 
    1b14:	c7 04 24 cc 49 00 00 	movl   $0x49cc,(%esp)
    1b1b:	e8 68 21 00 00       	call   3c88 <link>
    1b20:	eb 0c                	jmp    1b2e <linkunlink+0xf8>
    } else {
      unlink("x");
    1b22:	c7 04 24 22 45 00 00 	movl   $0x4522,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b47:	c7 44 24 04 d0 49 00 	movl   $0x49d0,0x4(%esp)
    1b4e:	00 
    1b4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b56:	e8 5c 22 00 00       	call   3db7 <printf>
}
    1b5b:	c9                   	leave  
    1b5c:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b68:	c7 44 24 04 df 49 00 	movl   $0x49df,0x4(%esp)
    1b6f:	00 
    1b70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b77:	e8 3b 22 00 00       	call   3db7 <printf>
  unlink("bd");
    1b7c:	c7 04 24 ec 49 00 00 	movl   $0x49ec,(%esp)
    1b83:	e8 f0 20 00 00       	call   3c78 <unlink>

  fd = open("bd", O_CREATE);
    1b88:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b8f:	00 
    1b90:	c7 04 24 ec 49 00 00 	movl   $0x49ec,(%esp)
  ...
  if(fd < 0){
    ...
    1ba5:	c7 44 24 04 ef 49 00 	movl   $0x49ef,0x4(%esp)
    1bac:	00 
    1bad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bb4:	e8 fe 21 00 00       	call   3db7 <printf>
    exit();
  ...
  unlink("bd");
    1c43:	c7 04 24 ec 49 00 00 	movl   $0x49ec,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9b:	c7 44 24 04 19 4a 00 	movl   $0x4a19,0x4(%esp)
    1ca2:	00 
    1ca3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1caa:	e8 08 21 00 00       	call   3db7 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cc1:	c7 44 24 04 2e 4a 00 	movl   $0x4a2e,0x4(%esp)
    1cc8:	00 
    1cc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd0:	e8 e2 20 00 00       	call   3db7 <printf>
}
    1cd5:	c9                   	leave  
    1cd6:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cdd:	c7 44 24 04 39 4a 00 	movl   $0x4a39,0x4(%esp)
    1ce4:	00 
    1ce5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cec:	e8 c6 20 00 00       	call   3db7 <printf>

  unlink("ff");
    1cf1:	c7 04 24 46 4a 00 00 	movl   $0x4a46,(%esp)
    1cf8:	e8 7b 1f 00 00       	call   3c78 <unlink>
  if(mkdir("dd") != 0){
    1cfd:	c7 04 24 49 4a 00 00 	movl   $0x4a49,(%esp)
    1d04:	e8 87 1f 00 00       	call   3c90 <mkdir>
    1d09:	85 c0                	test   %eax,%eax
    1d0b:	74 19                	je     1d26 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d0d:	c7 44 24 04 4c 4a 00 	movl   $0x4a4c,0x4(%esp)
    1d14:	00 
    1d15:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d1c:	e8 96 20 00 00       	call   3db7 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2d:	00 
    1d2e:	c7 04 24 64 4a 00 00 	movl   $0x4a64,(%esp)
  ...
  if(fd < 0){
    ...
    1d43:	c7 44 24 04 6a 4a 00 	movl   $0x4a6a,0x4(%esp)
    1d4a:	00 
    1d4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d52:	e8 60 20 00 00       	call   3db7 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d63:	00 
    1d64:	c7 44 24 04 46 4a 00 	movl   $0x4a46,0x4(%esp)
    1d6b:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddb:	00 
    1ddc:	c7 04 24 c8 4a 00 00 	movl   $0x4ac8,(%esp)
  ...
  if(fd < 0){
    ...
    1df1:	c7 44 24 04 d1 4a 00 	movl   $0x4ad1,0x4(%esp)
    1df8:	00 
    1df9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e00:	e8 b2 1f 00 00       	call   3db7 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e11:	00 
    1e12:	c7 44 24 04 e9 4a 00 	movl   $0x4ae9,0x4(%esp)
    1e19:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e37:	00 
    1e38:	c7 04 24 ec 4a 00 00 	movl   $0x4aec,(%esp)
  ...
  if(fd < 0){
    ...
    1e4d:	c7 44 24 04 f8 4a 00 	movl   $0x4af8,0x4(%esp)
    1e54:	00 
    1e55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e5c:	e8 56 1f 00 00       	call   3db7 <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e95:	c7 44 24 04 11 4b 00 	movl   $0x4b11,0x4(%esp)
    1e9c:	00 
    1e9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ea4:	e8 0e 1f 00 00       	call   3db7 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fef:	00 
    1ff0:	c7 04 24 2c 4b 00 00 	movl   $0x4b2c,(%esp)
  ...
  if(fd < 0){
    ...
    2005:	c7 44 24 04 f6 4b 00 	movl   $0x4bf6,0x4(%esp)
    200c:	00 
    200d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2014:	e8 9e 1d 00 00       	call   3db7 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    203e:	c7 44 24 04 0e 4c 00 	movl   $0x4c0e,0x4(%esp)
    2045:	00 
    2046:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    204d:	e8 65 1d 00 00       	call   3db7 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2423:	c7 44 24 04 88 4e 00 	movl   $0x4e88,0x4(%esp)
    242a:	00 
    242b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2432:	e8 80 19 00 00       	call   3db7 <printf>

  unlink("bigwrite");
    2437:	c7 04 24 97 4e 00 00 	movl   $0x4e97,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2456:	00 
    2457:	c7 04 24 97 4e 00 00 	movl   $0x4e97,(%esp)
    ...
    246c:	c7 44 24 04 a0 4e 00 	movl   $0x4ea0,0x4(%esp)
    2473:	00 
    2474:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247b:	e8 37 19 00 00       	call   3db7 <printf>
      exit();
    ...
    24c1:	c7 44 24 04 b8 4e 00 	movl   $0x4eb8,0x4(%esp)
    24c8:	00 
    24c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d0:	e8 e2 18 00 00       	call   3db7 <printf>
        exit();
    ...
    unlink("bigwrite");
    24ef:	c7 04 24 97 4e 00 00 	movl   $0x4e97,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    250f:	c7 44 24 04 ca 4e 00 	movl   $0x4eca,0x4(%esp)
    2516:	00 
    2517:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251e:	e8 94 18 00 00       	call   3db7 <printf>
}
    2523:	c9                   	leave  
    2524:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    252b:	c7 44 24 04 d7 4e 00 	movl   $0x4ed7,0x4(%esp)
    2532:	00 
    2533:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    253a:	e8 78 18 00 00       	call   3db7 <printf>

  unlink("bigfile");
    253f:	c7 04 24 e5 4e 00 00 	movl   $0x4ee5,(%esp)
    2546:	e8 2d 17 00 00       	call   3c78 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    254b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2552:	00 
    2553:	c7 04 24 e5 4e 00 00 	movl   $0x4ee5,(%esp)
  ...
  if(fd < 0){
    ...
    2568:	c7 44 24 04 ed 4e 00 	movl   $0x4eed,0x4(%esp)
    256f:	00 
    2570:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2577:	e8 3b 18 00 00       	call   3db7 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    25c7:	c7 44 24 04 03 4f 00 	movl   $0x4f03,0x4(%esp)
    25ce:	00 
    25cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d6:	e8 dc 17 00 00       	call   3db7 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25fc:	00 
    25fd:	c7 04 24 e5 4e 00 00 	movl   $0x4ee5,(%esp)
  ...
  if(fd < 0){
    ...
    2612:	c7 44 24 04 19 4f 00 	movl   $0x4f19,0x4(%esp)
    2619:	00 
    261a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2621:	e8 91 17 00 00       	call   3db7 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    265d:	c7 44 24 04 2e 4f 00 	movl   $0x4f2e,0x4(%esp)
    2664:	00 
    2665:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    266c:	e8 46 17 00 00       	call   3db7 <printf>
      exit();
    ...
    2685:	c7 44 24 04 43 4f 00 	movl   $0x4f43,0x4(%esp)
    268c:	00 
    268d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2694:	e8 1e 17 00 00       	call   3db7 <printf>
      exit();
    ...
    26d2:	c7 44 24 04 57 4f 00 	movl   $0x4f57,0x4(%esp)
    26d9:	00 
    26da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26e1:	e8 d1 16 00 00       	call   3db7 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 70 4f 00 	movl   $0x4f70,0x4(%esp)
    2716:	00 
    2717:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    271e:	e8 94 16 00 00       	call   3db7 <printf>
    exit();
    2723:	e8 00 15 00 00       	call   3c28 <exit>
  }
  unlink("bigfile");
    2728:	c7 04 24 e5 4e 00 00 	movl   $0x4ee5,(%esp)
    272f:	e8 44 15 00 00       	call   3c78 <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 8a 4f 00 	movl   $0x4f8a,0x4(%esp)
    273b:	00 
    273c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2743:	e8 6f 16 00 00       	call   3db7 <printf>
}
    2748:	c9                   	leave  
    2749:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 28 50 00 00 	movl   $0x5028,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 58 50 00 	movl   $0x5058,0x4(%esp)
    27da:	00 
    27db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e2:	e8 d0 15 00 00       	call   3db7 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 98 50 00 00 	movl   $0x5098,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 c8 50 00 	movl   $0x50c8,0x4(%esp)
    281b:	00 
    281c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2823:	e8 8f 15 00 00       	call   3db7 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 71 52 00 	movl   $0x5271,0x4(%esp)
    2a25:	00 
    2a26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a2d:	e8 85 13 00 00       	call   3db7 <printf>

  fd = open("dirfile", O_CREATE);
    2a32:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 7e 52 00 00 	movl   $0x527e,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 86 52 00 	movl   $0x5286,0x4(%esp)
    2a56:	00 
    2a57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a5e:	e8 54 13 00 00       	call   3db7 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 b7 52 00 00 	movl   $0x52b7,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 c2 52 00 	movl   $0x52c2,0x4(%esp)
    2ac0:	00 
    2ac1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ac8:	e8 ea 12 00 00       	call   3db7 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 b7 52 00 00 	movl   $0x52b7,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 eb 48 00 00 	movl   $0x48eb,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 5c 53 00 	movl   $0x535c,0x4(%esp)
    2bd8:	00 
    2bd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be0:	e8 d2 11 00 00       	call   3db7 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 7b 53 00 	movl   $0x537b,0x4(%esp)
    2c27:	00 
    2c28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c2f:	e8 83 11 00 00       	call   3db7 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 8f 53 00 	movl   $0x538f,0x4(%esp)
    2c4b:	00 
    2c4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c53:	e8 5f 11 00 00       	call   3db7 <printf>
}
    2c58:	c9                   	leave  
    2c59:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 9f 53 00 	movl   $0x539f,0x4(%esp)
    2c67:	00 
    2c68:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6f:	e8 43 11 00 00       	call   3db7 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d21:	00 
    2d22:	c7 04 24 df 53 00 00 	movl   $0x53df,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 df 53 00 00 	movl   $0x53df,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 02 52 00 00 	movl   $0x5202,(%esp)
    2d63:	e8 30 0f 00 00       	call   3c98 <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 e2 53 00 	movl   $0x53e2,0x4(%esp)
    2d6f:	00 
    2d70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d77:	e8 3b 10 00 00       	call   3db7 <printf>
}
    2d7c:	c9                   	leave  
    2d7d:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 f6 53 00 	movl   $0x53f6,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 1f 10 00 00       	call   3db7 <printf>
    ...
    2db5:	e8 6e 0e 00 00       	call   3c28 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 04 54 00 	movl   $0x5404,0x4(%esp)
    2dda:	00 
    2ddb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de2:	e8 d0 0f 00 00       	call   3db7 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 26 54 00 	movl   $0x5426,0x4(%esp)
    2dfc:	00 
    2dfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e04:	e8 ae 0f 00 00       	call   3db7 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 3a 54 00 	movl   $0x543a,0x4(%esp)
    2e29:	00 
    2e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e31:	e8 81 0f 00 00       	call   3db7 <printf>
    exit();
    2e36:	e8 ed 0d 00 00       	call   3c28 <exit>
  }
  
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 4d 54 00 	movl   $0x544d,0x4(%esp)
    2e42:	00 
    2e43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e4a:	e8 68 0f 00 00       	call   3db7 <printf>
}
    2e4f:	c9                   	leave  
    2e50:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    2e60:	c7 44 24 04 5b 54 00 	movl   $0x545b,0x4(%esp)
    2e67:	00 
    2e68:	89 04 24             	mov    %eax,(%esp)
    2e6b:	e8 47 0f 00 00       	call   3db7 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    ...
    2ec8:	c7 44 24 04 66 54 00 	movl   $0x5466,0x4(%esp)
    2ecf:	00 
    2ed0:	89 04 24             	mov    %eax,(%esp)
    2ed3:	e8 df 0e 00 00       	call   3db7 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f07:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    2f0c:	c7 44 24 04 81 54 00 	movl   $0x5481,0x4(%esp)
    2f13:	00 
    2f14:	89 04 24             	mov    %eax,(%esp)
    2f17:	e8 9b 0e 00 00       	call   3db7 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    2f4f:	c7 44 24 04 98 54 00 	movl   $0x5498,0x4(%esp)
    2f56:	00 
    2f57:	89 04 24             	mov    %eax,(%esp)
    2f5a:	e8 58 0e 00 00       	call   3db7 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    2faf:	c7 44 24 04 b4 54 00 	movl   $0x54b4,0x4(%esp)
    2fb6:	00 
    2fb7:	89 04 24             	mov    %eax,(%esp)
    2fba:	e8 f8 0d 00 00       	call   3db7 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    2ffa:	c7 44 24 04 f2 54 00 	movl   $0x54f2,0x4(%esp)
    3001:	00 
    3002:	89 04 24             	mov    %eax,(%esp)
    3005:	e8 ad 0d 00 00       	call   3db7 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    302b:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    ...
    303e:	c7 44 24 04 10 55 00 	movl   $0x5510,0x4(%esp)
    3045:	00 
    3046:	89 04 24             	mov    %eax,(%esp)
    3049:	e8 69 0d 00 00       	call   3db7 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    ...
    30a5:	c7 44 24 04 48 55 00 	movl   $0x5548,0x4(%esp)
    30ac:	00 
    30ad:	89 04 24             	mov    %eax,(%esp)
    30b0:	e8 02 0d 00 00       	call   3db7 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    30c9:	c7 44 24 04 70 55 00 	movl   $0x5570,0x4(%esp)
    30d0:	00 
    30d1:	89 04 24             	mov    %eax,(%esp)
    30d4:	e8 de 0c 00 00       	call   3db7 <printf>
    exit();
  ...
  if(c != a){
    ...
    3115:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    ...
    3128:	c7 44 24 04 a0 55 00 	movl   $0x55a0,0x4(%esp)
    312f:	00 
    3130:	89 04 24             	mov    %eax,(%esp)
    3133:	e8 7f 0c 00 00       	call   3db7 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    3161:	c7 44 24 04 69 45 00 	movl   $0x4569,0x4(%esp)
    3168:	00 
    3169:	89 04 24             	mov    %eax,(%esp)
    316c:	e8 46 0c 00 00       	call   3db7 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
    31e4:	00 
    31e5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31ec:	e8 c6 0b 00 00       	call   3db7 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3242:	00 
    3243:	c7 44 24 04 22 45 00 	movl   $0x4522,0x4(%esp)
    324a:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e4:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    32e9:	c7 44 24 04 da 55 00 	movl   $0x55da,0x4(%esp)
    32f0:	00 
    32f1:	89 04 24             	mov    %eax,(%esp)
    32f4:	e8 be 0a 00 00       	call   3db7 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    332c:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    3331:	c7 44 24 04 f5 55 00 	movl   $0x55f5,0x4(%esp)
    3338:	00 
    3339:	89 04 24             	mov    %eax,(%esp)
    333c:	e8 76 0a 00 00       	call   3db7 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    337b:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    3380:	c7 44 24 04 03 56 00 	movl   $0x5603,0x4(%esp)
    3387:	00 
    3388:	89 04 24             	mov    %eax,(%esp)
    338b:	e8 27 0a 00 00       	call   3db7 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33ed:	c7 04 24 12 56 00 00 	movl   $0x5612,(%esp)
    33f4:	e8 8f 08 00 00       	call   3c88 <link>
    33f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    33fc:	74 1a                	je     3418 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33fe:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    3403:	c7 44 24 04 1d 56 00 	movl   $0x561d,0x4(%esp)
    340a:	00 
    340b:	89 04 24             	mov    %eax,(%esp)
    340e:	e8 a4 09 00 00       	call   3db7 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    342b:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    3430:	c7 44 24 04 36 56 00 	movl   $0x5636,0x4(%esp)
    3437:	00 
    3438:	89 04 24             	mov    %eax,(%esp)
    343b:	e8 77 09 00 00       	call   3db7 <printf>
}
    3440:	c9                   	leave  
    3441:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3448:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    344d:	c7 44 24 04 43 56 00 	movl   $0x5643,0x4(%esp)
    3454:	00 
    3455:	89 04 24             	mov    %eax,(%esp)
    3458:	e8 5a 09 00 00       	call   3db7 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3475:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    347a:	c7 44 24 04 4d 56 00 	movl   $0x564d,0x4(%esp)
    3481:	00 
    3482:	89 04 24             	mov    %eax,(%esp)
    3485:	e8 2d 09 00 00       	call   3db7 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    349d:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    34a2:	c7 44 24 04 5e 56 00 	movl   $0x565e,0x4(%esp)
    34a9:	00 
    34aa:	89 04 24             	mov    %eax,(%esp)
    34ad:	e8 05 09 00 00       	call   3db7 <printf>
}
    34b2:	c9                   	leave  
    34b3:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ba:	c7 04 24 6b 56 00 00 	movl   $0x566b,(%esp)
  ...
  if(pid == 0){
    ...
    34e4:	c7 04 85 00 5f 00 00 	movl   $0x5678,0x5f00(,%eax,4)
    34eb:	78 56 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3503:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    3508:	c7 44 24 04 55 57 00 	movl   $0x5755,0x4(%esp)
    350f:	00 
    3510:	89 04 24             	mov    %eax,(%esp)
    3513:	e8 9f 08 00 00       	call   3db7 <printf>
    exec("echo", args);
    3518:	c7 44 24 04 00 5f 00 	movl   $0x5f00,0x4(%esp)
    351f:	00 
    3520:	c7 04 24 7c 41 00 00 	movl   $0x417c,(%esp)
    3527:	e8 34 07 00 00       	call   3c60 <exec>
    printf(stdout, "bigarg test ok\n");
    352c:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    3531:	c7 44 24 04 62 57 00 	movl   $0x5762,0x4(%esp)
    3538:	00 
    3539:	89 04 24             	mov    %eax,(%esp)
    353c:	e8 76 08 00 00       	call   3db7 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3541:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3548:	00 
    3549:	c7 04 24 6b 56 00 00 	movl   $0x566b,(%esp)
    ...
    356e:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    3573:	c7 44 24 04 72 57 00 	movl   $0x5772,0x4(%esp)
    357a:	00 
    357b:	89 04 24             	mov    %eax,(%esp)
    357e:	e8 34 08 00 00       	call   3db7 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3594:	00 
    3595:	c7 04 24 6b 56 00 00 	movl   $0x566b,(%esp)
  ...
  if(fd < 0){
    ...
    35aa:	a1 d4 5e 00 00       	mov    0x5ed4,%eax
    35af:	c7 44 24 04 8b 57 00 	movl   $0x578b,0x4(%esp)
    35b6:	00 
    35b7:	89 04 24             	mov    %eax,(%esp)
    35ba:	e8 f8 07 00 00       	call   3db7 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35cf:	c7 04 24 6b 56 00 00 	movl   $0x566b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35eb:	c7 44 24 04 a0 57 00 	movl   $0x57a0,0x4(%esp)
    35f2:	00 
    35f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35fa:	e8 b8 07 00 00       	call   3db7 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36db:	c7 44 24 04 ad 57 00 	movl   $0x57ad,0x4(%esp)
    36e2:	00 
    36e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36ea:	e8 c8 06 00 00       	call   3db7 <printf>
    ...
    3712:	c7 44 24 04 b9 57 00 	movl   $0x57b9,0x4(%esp)
    3719:	00 
    371a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3721:	e8 91 06 00 00       	call   3db7 <printf>
      break;
    ...
    376a:	c7 44 24 04 c9 57 00 	movl   $0x57c9,0x4(%esp)
    3771:	00 
    3772:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3779:	e8 39 06 00 00       	call   3db7 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3885:	c7 44 24 04 d9 57 00 	movl   $0x57d9,0x4(%esp)
    388c:	00 
    388d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3894:	e8 1e 05 00 00       	call   3db7 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38a2:	a1 d8 5e 00 00       	mov    0x5ed8,%eax
    38a7:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38ad:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38b2:	a3 d8 5e 00 00       	mov    %eax,0x5ed8
  return randstate;
    38b7:	a1 d8 5e 00 00       	mov    0x5ed8,%eax
}
    38bc:	5d                   	pop    %ebp
    38bd:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3913:	00 
    3914:	c7 04 24 03 58 00 00 	movl   $0x5803,(%esp)
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    3d01:	e8 42 ff ff ff       	call   3c48 <write>
}
    3d06:	c9                   	leave  
    3d07:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3d4e:	0f b6 90 dc 5e 00 00 	movzbl 0x5edc(%eax),%edx
    3d55:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d58:	03 45 f4             	add    -0xc(%ebp),%eax
    3d5b:	88 10                	mov    %dl,(%eax)
    3d5d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    3d61:	8b 55 10             	mov    0x10(%ebp),%edx
    3d64:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3d67:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d6a:	ba 00 00 00 00       	mov    $0x0,%edx
    3d6f:	f7 75 d4             	divl   -0x2c(%ebp)
    3d72:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d75:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3d79:	75 c4                	jne    3d3f <printint+0x37>
  if(neg)
    3d7b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d7f:	74 2a                	je     3dab <printint+0xa3>
    buf[i++] = '-';
    3d81:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d84:	03 45 f4             	add    -0xc(%ebp),%eax
    3d87:	c6 00 2d             	movb   $0x2d,(%eax)
    3d8a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    3d8e:	eb 1b                	jmp    3dab <printint+0xa3>
    putc(fd, buf[i]);
    3d90:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d93:	03 45 f4             	add    -0xc(%ebp),%eax
    3d96:	0f b6 00             	movzbl (%eax),%eax
    3d99:	0f be c0             	movsbl %al,%eax
    3d9c:	89 44 24 04          	mov    %eax,0x4(%esp)
    3da0:	8b 45 08             	mov    0x8(%ebp),%eax
    3da3:	89 04 24             	mov    %eax,(%esp)
    3da6:	e8 35 ff ff ff       	call   3ce0 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3dab:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    3daf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3db3:	79 db                	jns    3d90 <printint+0x88>
    putc(fd, buf[i]);
}
    3db5:	c9                   	leave  
    3db6:	c3                   	ret    
...
{
    3db7:	55                   	push   %ebp
    3db8:	89 e5                	mov    %esp,%ebp
    3dba:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3dbd:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3dc4:	8d 45 0c             	lea    0xc(%ebp),%eax
    3dc7:	83 c0 04             	add    $0x4,%eax
    3dca:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3dcd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3dd4:	e9 7d 01 00 00       	jmp    3f56 <printf+0x19f>
    c = fmt[i] & 0xff;
    3dd9:	8b 55 0c             	mov    0xc(%ebp),%edx
    3ddc:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3ddf:	01 d0                	add    %edx,%eax
    3de1:	0f b6 00             	movzbl (%eax),%eax
    3de4:	0f be c0             	movsbl %al,%eax
    3de7:	25 ff 00 00 00       	and    $0xff,%eax
    3dec:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3def:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3df3:	75 2c                	jne    3e21 <printf+0x6a>
      if(c == '%'){
    3df5:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3df9:	75 0c                	jne    3e07 <printf+0x50>
        state = '%';
    3dfb:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3e02:	e9 4b 01 00 00       	jmp    3f52 <printf+0x19b>
      } else {
        putc(fd, c);
    3e07:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3e0a:	0f be c0             	movsbl %al,%eax
    3e0d:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e11:	8b 45 08             	mov    0x8(%ebp),%eax
    3e14:	89 04 24             	mov    %eax,(%esp)
    3e17:	e8 c4 fe ff ff       	call   3ce0 <putc>
    3e1c:	e9 31 01 00 00       	jmp    3f52 <printf+0x19b>
      }
    } else if(state == '%'){
    3e21:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3e25:	0f 85 27 01 00 00    	jne    3f52 <printf+0x19b>
      if(c == 'd'){
    3e2b:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3e2f:	75 2d                	jne    3e5e <printf+0xa7>
        printint(fd, *ap, 10, 1);
    3e31:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e34:	8b 00                	mov    (%eax),%eax
    3e36:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e3d:	00 
    3e3e:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e45:	00 
    3e46:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e4a:	8b 45 08             	mov    0x8(%ebp),%eax
    3e4d:	89 04 24             	mov    %eax,(%esp)
    3e50:	e8 b3 fe ff ff       	call   3d08 <printint>
        ap++;
    3e55:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e59:	e9 ed 00 00 00       	jmp    3f4b <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    3e5e:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3e62:	74 06                	je     3e6a <printf+0xb3>
    3e64:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3e68:	75 2d                	jne    3e97 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    3e6a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e6d:	8b 00                	mov    (%eax),%eax
    3e6f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e76:	00 
    3e77:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e7e:	00 
    3e7f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e83:	8b 45 08             	mov    0x8(%ebp),%eax
    3e86:	89 04 24             	mov    %eax,(%esp)
    3e89:	e8 7a fe ff ff       	call   3d08 <printint>
        ap++;
    3e8e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e92:	e9 b4 00 00 00       	jmp    3f4b <printf+0x194>
      } else if(c == 's'){
    3e97:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    3e9b:	75 46                	jne    3ee3 <printf+0x12c>
        s = (char*)*ap;
    3e9d:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3ea0:	8b 00                	mov    (%eax),%eax
    3ea2:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    3ea5:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    3ea9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3ead:	75 27                	jne    3ed6 <printf+0x11f>
          s = "(null)";
    3eaf:	c7 45 f4 3e 58 00 00 	movl   $0x583e,-0xc(%ebp)
        while(*s != 0){
    3eb6:	eb 1e                	jmp    3ed6 <printf+0x11f>
          putc(fd, *s);
    3eb8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ebb:	0f b6 00             	movzbl (%eax),%eax
    3ebe:	0f be c0             	movsbl %al,%eax
    3ec1:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ec5:	8b 45 08             	mov    0x8(%ebp),%eax
    3ec8:	89 04 24             	mov    %eax,(%esp)
    3ecb:	e8 10 fe ff ff       	call   3ce0 <putc>
          s++;
    3ed0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    3ed4:	eb 01                	jmp    3ed7 <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    3eda:	0f b6 00             	movzbl (%eax),%eax
    3edd:	84 c0                	test   %al,%al
    3edf:	75 d7                	jne    3eb8 <printf+0x101>
    3ee1:	eb 68                	jmp    3f4b <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3ee3:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    3ee7:	75 1d                	jne    3f06 <printf+0x14f>
        putc(fd, *ap);
    3ee9:	8b 45 e8             	mov    -0x18(%ebp),%eax
    ...
    3efb:	e8 e0 fd ff ff       	call   3ce0 <putc>
        ap++;
    3f00:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3f04:	eb 45                	jmp    3f4b <printf+0x194>
      } else if(c == '%'){
    3f06:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3f0a:	75 17                	jne    3f23 <printf+0x16c>
        putc(fd, c);
    3f0c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f0f:	0f be c0             	movsbl %al,%eax
    3f12:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f16:	8b 45 08             	mov    0x8(%ebp),%eax
    3f19:	89 04 24             	mov    %eax,(%esp)
    3f1c:	e8 bf fd ff ff       	call   3ce0 <putc>
    3f21:	eb 28                	jmp    3f4b <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3f23:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    3f2a:	00 
    3f2b:	8b 45 08             	mov    0x8(%ebp),%eax
    3f2e:	89 04 24             	mov    %eax,(%esp)
    3f31:	e8 aa fd ff ff       	call   3ce0 <putc>
        putc(fd, c);
    3f36:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f39:	0f be c0             	movsbl %al,%eax
    3f3c:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f40:	8b 45 08             	mov    0x8(%ebp),%eax
    3f43:	89 04 24             	mov    %eax,(%esp)
    3f46:	e8 95 fd ff ff       	call   3ce0 <putc>
      }
      state = 0;
    3f4b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3f52:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    3f56:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f59:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3f5c:	01 d0                	add    %edx,%eax
    3f5e:	0f b6 00             	movzbl (%eax),%eax
    3f61:	84 c0                	test   %al,%al
    3f63:	0f 85 70 fe ff ff    	jne    3dd9 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f7b:	a1 88 5f 00 00       	mov    0x5f88,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    403c:	a3 88 5f 00 00       	mov    %eax,0x5f88
}
    4041:	c9                   	leave  
    4042:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    4062:	e8 49 fc ff ff       	call   3cb0 <sbrk>
  ...
  return freep;
    4094:	a1 88 5f 00 00       	mov    0x5f88,%eax
}
    4099:	c9                   	leave  
    409a:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40b0:	a1 88 5f 00 00       	mov    0x5f88,%eax
    40b5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40b8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40bc:	75 23                	jne    40e1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40be:	c7 45 f0 80 5f 00 00 	movl   $0x5f80,-0x10(%ebp)
    40c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40c8:	a3 88 5f 00 00       	mov    %eax,0x5f88
    40cd:	a1 88 5f 00 00       	mov    0x5f88,%eax
    40d2:	a3 80 5f 00 00       	mov    %eax,0x5f80
    base.s.size = 0;
    40d7:	c7 05 84 5f 00 00 00 	movl   $0x0,0x5f84
    40de:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4134:	a3 88 5f 00 00       	mov    %eax,0x5f88
      return (void*)(p + 1);
    ...
    if(p == freep)
    4141:	a1 88 5f 00 00       	mov    0x5f88,%eax
