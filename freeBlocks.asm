...
main(void)
{
  ...
  printf(1,"No. of free blocks = %d\n",getFreeBlocks());
   9:	e8 2a 03 00 00       	call   338 <getFreeBlocks>
   e:	89 44 24 08          	mov    %eax,0x8(%esp)
  12:	c7 44 24 04 f3 07 00 	movl   $0x7f3,0x4(%esp)
  19:	00 
  1a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  21:	e8 09 04 00 00       	call   42f <printf>
  exit();
  26:	e8 65 02 00 00       	call   290 <exit>
  2b:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c6:	0f b6 90 50 0a 00 00 	movzbl 0xa50(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 525:	75 27                	jne    54e <printf+0x11f>
          s = "(null)";
 527:	c7 45 f4 0c 08 00 00 	movl   $0x80c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f3:	a1 6c 0a 00 00       	mov    0xa6c,%eax
...
free(void *ap)
{
 ...
 6b4:	a3 6c 0a 00 00       	mov    %eax,0xa6c
}
 6b9:	c9                   	leave  
 6ba:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 707:	e8 d8 fe ff ff       	call   5e4 <free>
  return freep;
 70c:	a1 6c 0a 00 00       	mov    0xa6c,%eax
}
 711:	c9                   	leave  
 712:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 725:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 728:	a1 6c 0a 00 00       	mov    0xa6c,%eax
 72d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 730:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 734:	75 23                	jne    759 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 736:	c7 45 f0 64 0a 00 00 	movl   $0xa64,-0x10(%ebp)
 73d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 740:	a3 6c 0a 00 00       	mov    %eax,0xa6c
 745:	a1 6c 0a 00 00       	mov    0xa6c,%eax
 74a:	a3 64 0a 00 00       	mov    %eax,0xa64
    base.s.size = 0;
 74f:	c7 05 68 0a 00 00 00 	movl   $0x0,0xa68
 756:	00 00 00 
  }
 ...
 7ac:	a3 6c 0a 00 00       	mov    %eax,0xa6c
      return (void*)(p + 1);
 ...
 7b7:	eb 38                	jmp    7f1 <malloc+0xde>
    ...
    if(p == freep)
 7b9:	a1 6c 0a 00 00       	mov    0xa6c,%eax
